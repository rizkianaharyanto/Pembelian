    ...
    $("a").click(function() {
        ...
        if (id == "details") {
            ...
            $('#judulmodal').html(
                ...
                '<h5 id = "nama_supplier" class = "align-self-center"> Pemesanan </h5>'
            );
            $('#bodymodal').html(
                '<form>' +
            ...
            $('#lebarmodal').addClass('modal-xl');
            $('#judulmodal').html(
                '<h5 class="align-self-center">Edit Pemesanan</h5>'
            );
            $('#bodymodal').html(
                '<div class="row">' +
                '<div class="col-md-12">' +
            ...
            $('#judulmodal').html(
                '<h5 class="align-self-center">Hapus Pemesanan</h5>'
            );
            $('#bodymodal').html(
                '<p>Apakah kamu yakin ingin menghapus Pemesanan A ?</p>'
            );
            $('#footermodal').html(
                '<button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>' +
